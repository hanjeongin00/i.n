...
if choose == "홈":
    st.markdown(f"<div class='section'>환영합니다! 이곳은 저를 소개하는 페이지 입니다. 사이드바에서 아이콘을 누르면 자세한 내용을 확인 해 보실 수 있습니다. 아래 궁금한 것을 질문할 수도 있습니다"
                f".___.</div>", unsafe_allow_html=True)
elif choose == "아바타":
